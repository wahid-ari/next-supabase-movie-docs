...
Export Collection v2.1 > [JSON](https://github.com/wahid-ari/next-supabase-music-docs/blob/master/public/Next-Supabase-Movie.postman_collection.json) (github)

Export Collection v2.1 > [JSON](https://github.com/wahid-ari/next-supabase-music-docs/raw/master/public/Next-Supabase-Movie.postman_collection.json) (download)
